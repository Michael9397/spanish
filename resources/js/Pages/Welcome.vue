...
<!--                </svg>-->
<!--            </div>-->
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0 text-5xl text-red-800 font-extrabold">
                Spanish Practice
            </div>
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Practice conjugating verbs in Spanish.  One at a time.  Hablar, Comer, and Subir for regular verbs, and many irregular verbs to practice with them.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Practice conjugating multiple verbs in Spanish.  Choose a verb and conjugate it in all its forms.  Starting with Indicatve.
                            </div>
                        </div>
                    </div>
